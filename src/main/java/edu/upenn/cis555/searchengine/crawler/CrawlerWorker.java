...
public class CrawlerWorker implements Runnable {
	...
	public static Pattern blackLst = Pattern.compile("cn|.39.|163|nuomi|cn|search|gril|porn|sex|create|subscribe|jp|hao123|qq|jd|shanghai|beijing|china|360|hao315|leju|kankan|pussy|blog|fangjia|fangzi|cheshi|fuck|fbi");
