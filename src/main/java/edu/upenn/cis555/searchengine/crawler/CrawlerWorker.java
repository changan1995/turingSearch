...
public class CrawlerWorker implements Runnable {
	...
	public static Pattern blackLst = Pattern.compile("cn|.39.|163|nuomi|.ro|.it|glassdoor|fr.|academia|getithalfoff|cn|search|gril|porn|sex|create|subscribe|jp|kr|korea|hao123|qq|jd|shanghai|beijing|china|360|climatemps|hao315|leju|kankan|pussy|blog|fangjia|fangzi|cheshi|fuck|fbi");
